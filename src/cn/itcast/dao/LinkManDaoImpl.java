...
public class LinkManDaoImpl extends HibernateDaoSupport implements LinkManDao {
	...
	public List<LinkMan> list() {
		return (List<LinkMan>) this.getHibernateTemplate().find("from LinkMan");//查询所有
	}
	...
	public void update(LinkMan linkMan) {
        this.getHibernateTemplate().update(linkMan);//到linkMan对象中找到id值,根据对象值进行修改
	}
...
//	}
		...
		public List<LinkMan> findCondition(LinkMan linkMan) {
			...
			if(linkMan.getLkmName()!=null && !"".equals(linkMan.getLkmName())) {//第一个条件
